...
<body>
	...
	<table bordercolor="lightgary;" border="2"
		...
		<%
			Object attribute = request.getAttribute("reworkArrayObject");
			ArrayList<HashMap<String, String>> objArrayList = (ArrayList<HashMap<String, String>>) attribute;
			System.out.println("objArray : " + objArrayList);
			...
			while (iterator.hasNext()) {
				...
				objDate = objHashMap.get("last_modified_date");
		%>
		<tr align="center">
			<td><a
				href="WorkFlowController?app-no=<%=app_no%>&buttonVal=rework_user"><%=app_no%></a>
			</td>
			<td><%=custid%></td>
			<td><%=pan_no%></td>
			<td><%=firstname%></td>
