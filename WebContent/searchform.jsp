...
<body>
	<%
		Object attribute = request.getAttribute("searchFromArrayObj");
		...
		while (iterator.hasNext()) {
			...
			cardType = objHashMap.get("cardType");
			kycCheck = objHashMap.get("kycCheck");
			cardDetails = objHashMap.get("cardDetails");
			creditLimit = objHashMap.get("creditLimit");
			creditRating = objHashMap.get("creditRating");
		}
	%>
		...
		<div align="center" style="font-style: normal;">
			...
			<table bordercolor="lightgary;" border="2"
				...
				<tr>
					...
					<td><input type="text" name="paddress" readonly="readonly"
				...
				<tr>
					...
					<td><input type="text" value="<%=cardType%>" name="pan"
						readonly="readonly"></td>
					<td>
				</tr>
				<tr>
					...
					<td><input type="text" value="<%=creditRating%>"> <!-- <select name="credit_risk" ">
				...
				<tr>
					...
					<td><input type="text" value="<%=kycCheck%>"> <!-- <input type="radio" value="" name="kyc_check" readonly="readonly">Yes
						<input type="radio" value="" name="kyc_check">No --></td>
				</tr>
				<tr>
					<th>Card Details<sup style="color: white;">*</sup>
					</th>
					<td><input type="text" value="<%=cardDetails%>"
						name="card_details"></td>
				</tr>
				<tr>
					<th>Credit Limit<sup style="color: white;">*</sup>
					</th>
					<td><input type="text" value="<%=creditLimit%>"
						name="credit_limit"></td>
				</tr>
				<tr>
					<th>Application Form<sup style="color: white;">*</sup>
					</th>
					<td><a
						href="SearchController?buttonVal=app_form&app_no=<%=app_no%>&form=applicationform"
				...
				<tr>
					...
					<td><a
						href="SearchController?buttonVal=id_proof&app_no=<%=app_no%>&form=idproof"
				...
				<tr>
					...
					<td><a
						href="SearchController?buttonVal=sdocs&app_no=<%=app_no%>&form=sdoc"
						style="color: white;">Supporting Documents</a></td>
				</tr>
			</table>
			<br>
			<%--  <a
				href="WorkFlowController?buttonVal=approve&custid=<%=custid%>"
				...
				<input type="submit" value="Rework" name="buttonVal" style="border-color: black; padding: 10px;
				 background-color: gray; color: black; 
				border-style: none;; border-color: black; font-style: normal;">
			...
			<a href="WorkFlowController?buttonVal=reject&custid=<%=custid %>"
				style="border-color: black; padding: 10px; background-color: gray; color: black;
				 border-style: none;; border-color: black; font-style: normal;">Reject</a> --%>
